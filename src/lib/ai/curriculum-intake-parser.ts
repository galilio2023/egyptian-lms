...
const MINISTRY_CURRICULUM_PRESETS: Record<string, Omit<ParsedCurriculumUnit, "pdfFileName">> = {
  ...
  "grade-4-connect": {
    ...
    term: 1,
    unitNumber: 1,
    titleEnglish: "Unit 1: I Feel Good!",
    titleArabic: "الوحدة الأولى: أشعر بصحة جيدة ونشاط!",
    description: "منهج كونكت الرسمي للصف الرابع الابتدائي — الجهاز الهضمي والتنفسي، إنتاج الغذاء في مصر، وحياة الحيوانات بالصحراء المصرية.",
    suggestedPriceEgp: 270,
    vocabulary: [
      { word: "Digestive system", arabicMeaning: "الجهاز الهضمي", phonicsFocus: "Soft g /dʒ/", exampleSentence: "We use our digestive system to digest food.", category: "Science" },
      { word: "Stomach", arabicMeaning: "المعدة", phonicsFocus: "ch pronounced as /k/", exampleSentence: "Food moves to the stomach.", category: "Science" },
      { word: "Lungs", arabicMeaning: "الرئتان", phonicsFocus: "Short /ʌ/ and -ng", exampleSentence: "We have two lungs inside our chest.", category: "Science" },
      { word: "Diaphragm", arabicMeaning: "عضلة الحجاب الحاجز", phonicsFocus: "Silent 'g' in phragm", exampleSentence: "The diaphragm pulls air into our lungs.", category: "Science" },
      { word: "Egyptian farmers", arabicMeaning: "الفلاحون المصريون", phonicsFocus: "Suffix -ers", exampleSentence: "Egyptian farmers produce chickens and rice.", category: "Social" },
      { word: "Nutrients", arabicMeaning: "العناصر الغذائية المفيدة", phonicsFocus: "Tri-syllable stress", exampleSentence: "Our body needs healthy nutrients.", category: "Health" },
    ],
    lessons: [
      {
        title: "Lesson 1: The Human Digestive System",
        orderIndex: 1,
        isFreePreview: true,
        learningObjectives: ["تتبع رحلة الطعام من الفم إلى المعدة والأمعاء", "استخدام أفعال العمليات الحيوية: chew, swallow, digest"],
        phonicsRule: "نطق ch كصوت /k/ في كلمات Stomach و Chemistry",
        grammarPoint: "المضارع البسيط للحقائق العلمية: The stomach digests food",
        suggestedVideoScriptOutline: "رحلة كرتونية ثلاثية الأبعاد داخل جسم الإنسان مع شخصية كبسولة الغذاء لشرح هضم الطعام ببساطة.",
      },
      {
        title: "Lesson 2: How We Breathe (Respiratory System)",
        orderIndex: 2,
        isFreePreview: false,
        learningObjectives: ["شرح عملية التنفس والشهيق والزفير", "دور عضلة الحجاب الحاجز Diaphragm"],
        phonicsRule: "الحروف الصامتة (Silent G in diaphragm)",
        grammarPoint: "استخدام حروف الجر مع الحركة: into / out of",
        suggestedVideoScriptOutline: "تمثيل بالونين ورئة اصطناعية لشرح تمدد الرئتين عند سحب الهواء النقي.",
      },
      {
        title: "Lesson 3: Egyptian Agriculture & Healthy Food",
        orderIndex: 3,
        isFreePreview: false,
        learningObjectives: ["المحاصيل الزراعية المصرية (Rice, Onions, Tomatoes, Potatoes)", "إنتاج البيض والدجاج المحلي"],
        phonicsRule: "نهايات الجمع المنتظمة وغير المنتظمة (-s, -es)",
        grammarPoint: "أدوات الربط: and / but للتناقض والإضافة",
        suggestedVideoScriptOutline: "جولة ممتعة في ريف مصر الأخضر وسؤال تفاعلي حول المحاصيل المفضلة لكل بطل.",
      },
    ],
    quizQuestions: [
      {
        id: "g4-q1",
        questionText: "We use our _____ system to digest what we eat and drink.",
        questionType: "multiple_choice",
        options: [
          { id: "o1", text: "digestive", isCorrect: true },
          { id: "o2", text: "respiratory", isCorrect: false },
          { id: "o3", text: "circulatory", isCorrect: false },
        ],
        explanation: "الجهاز الهضمي (Digestive system) هو المسؤول عن هضم الطعام والشراب.",
        points: 1,
      },
      {
        id: "g4-q2",
        questionText: "The 'ch' in 'stomach' is pronounced as:",
        questionType: "multiple_choice",
        options: [
          { id: "o1", text: "/k/", isCorrect: true },
          { id: "o2", text: "/tʃ/ as in chair", isCorrect: false },
          { id: "o3", text: "/sh/", isCorrect: false },
        ],
        explanation: "في كلمة Stomach تنطق ch كحرف الكاف /k/.",
        points: 1,
      },
      {
        id: "g4-q3",
        questionText: "Egyptian farmers produce food for us to eat.",
        questionType: "true_false",
        options: [
          { id: "o1", text: "صح (True)", isCorrect: true },
          { id: "o2", text: "خطأ (False)", isCorrect: false },
        ],
        explanation: "صحيح! الفلاحون المصريون يزرعون الأرز والخضروات ويربون الدواجن.",
        points: 1,
      },
    ],
  },
  ...
  "grade-5-connect": {
    ...
    term: 1,
    unitNumber: 1,
    titleEnglish: "Unit 1: We Plant Our Food!",
    titleArabic: "الوحدة الأولى: نحن نزرع طعامنا بأيدينا!",
    description: "منهج كونكت الرسمي للصف الخامس الابتدائي — الأطعمة الصحية والتقليدية، أشجار المانجو والليمون، وقصة جاك وشجرة الفاصوليا الشهيرة.",
    suggestedPriceEgp: 280,
    vocabulary: [
      { word: "Pineapples", arabicMeaning: "أناناس", phonicsFocus: "Compound word", exampleSentence: "Pineapples don't grow on trees, they grow on the ground.", category: "Food" },
      { word: "Limes", arabicMeaning: "ليمون أخضر حامض", phonicsFocus: "Magic 'e' makes /aɪ/", exampleSentence: "We pick fresh limes from the garden.", category: "Food" },
      { word: "Ingredients", arabicMeaning: "مكونات ومقادير الوصفة", phonicsFocus: "Multi-syllable word", exampleSentence: "What are the ingredients of Koshari?", category: "Cooking" },
      { word: "Giant", arabicMeaning: "عملاق ضخم", phonicsFocus: "Soft G /dʒ/ sound", exampleSentence: "Jack saw a huge giant in the castle.", category: "Story" },
      { word: "Healthy market", arabicMeaning: "سوق المنتجات الصحية الطازجة", phonicsFocus: "R-controlled vowel /ɑːr/", exampleSentence: "Grandpa sells beans at the market.", category: "Places" },
    ],
    lessons: [
      {
        title: "Lesson 1: What's Your Favorite Food?",
        orderIndex: 1,
        isFreePreview: true,
        learningObjectives: ["الحديث عن الأطعمة المفضلة: What's your favorite healthy food?", "استخدام Like / Love / Prefer"],
        phonicsRule: "قاعدة السحر Magic E في كلمات Lime و Pine و Like",
        grammarPoint: "صيغ التفضيل البسيطة: I think [food] is healthy, but [food] is unhealthy",
        suggestedVideoScriptOutline: "حوار كرتوني مرح في المطبخ بين الأبطال حول فوائد الشوكولاتة الصحية مقابل الخضار والفاكهة الطازجة.",
      },
      {
        title: "Lesson 2: Jack and the Beanstalk Story",
        orderIndex: 2,
        isFreePreview: false,
        learningObjectives: ["قراءة قصة جاك وشجرة الفاصوليا واستخلاص العبرة الأخلاقية", "تسلسل أحداث القصة"],
        phonicsRule: "نطق حرف G المعطش /dʒ/ في كلمة Giant",
        grammarPoint: "زمن الماضي البسيط في سرد القصص: climbed, looked, ran",
        suggestedVideoScriptOutline: "أنيميشن كرتوني كامل لقصة جاك وصعوده فوق السحاب نحو قلعة العملاق الذهبية.",
      },
    ],
    quizQuestions: [
      {
        id: "g5-q1",
        questionText: "Pineapples grow on _____.",
        questionType: "multiple_choice",
        options: [
          { id: "o1", text: "the ground", isCorrect: true },
          { id: "o2", text: "trees", isCorrect: false },
          { id: "o3", text: "the roof", isCorrect: false },
        ],
        explanation: "الأناناس ينمو على الأرض وليس على فروع الأشجار!",
        points: 1,
      },
    ],
  },
  ...
  "grade-6-connect": {
    ...
    term: 1,
    unitNumber: 1,
    titleEnglish: "Unit 1: Green Cities & Community Gardens",
    titleArabic: "الوحدة الأولى: المدن الخضراء والحدائق المجتمعية",
    description: "منهج كونكت الرسمي للصف السادس الابتدائي — مبادرات أسطح العمارات الخضراء، زراعة الخضروات العضوية، ومبادرة Mini-Forest لمدن نظيفة.",
    suggestedPriceEgp: 300,
    vocabulary: [
      { word: "Community garden", arabicMeaning: "حديقة المجتمع المشتركة", phonicsFocus: "Suffix -ity", exampleSentence: "We have a community garden on our roof.", category: "Environment" },
      { word: "Apartment block", arabicMeaning: "عمارة سكنية", phonicsFocus: "Compound noun", exampleSentence: "They live in a modern apartment block.", category: "Housing" },
      { word: "Organic fertilizer", arabicMeaning: "سماد عضوي طبيعي", phonicsFocus: "Soft C and stress", exampleSentence: "We only use organic fertilizer for our plants.", category: "Agriculture" },
      { word: "Mini-forest", arabicMeaning: "غابة صغيرة في قلب المدينة", phonicsFocus: "Compound noun", exampleSentence: "Mini-forests help clean the air.", category: "Nature" },
    ],
    lessons: [
      {
        title: "Lesson 1: The Roof Garden Project",
        orderIndex: 1,
        isFreePreview: true,
        learningObjectives: ["شرح فكرة استغلال أسطح المنازل في زراعة النباتات", "فوائد تقليل التلوث وإنتاج طعام عضوي"],
        phonicsRule: "أصوات /f/ في Fertilizer و Forest",
        grammarPoint: "ظروف التكرار (Adverbs of frequency: always, usually, often, never)",
        suggestedVideoScriptOutline: "مشهد مبهج لحديقة سطح ملونة بالقاهرة مع شرح كيفية زراعة النعناع والطماطم بالأسمدة الطبيعية.",
      },
    ],
    quizQuestions: [
      {
        id: "g6-q1",
        questionText: "A _____ is a green space on the roof of an apartment building.",
        questionType: "multiple_choice",
        options: [
          { id: "o1", text: "roof garden", isCorrect: true },
          { id: "o2", text: "supermarket", isCorrect: false },
          { id: "o3", text: "car park", isCorrect: false },
        ],
        explanation: "حديقة السطح (Roof garden) هي مساحة زراعية خضراء على سطح العمارة.",
        points: 1,
      },
    ],
  },
