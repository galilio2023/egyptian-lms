...
export const platformSettings = pgTable('platform_settings', {
  ...
  teacherNameArabic: text('teacher_name_arabic').default('المعلم المشرف').notNull(),
  teacherNameEnglish: text('teacher_name_english').default('Lead Instructor').notNull(),
  teacherTitle: text('teacher_title').default('المشرف الأكاديمي وكبير المعلمين'),
  teacherBio: text('teacher_bio'),
  whatsappNumber: text('whatsapp_number').default('201000000000').notNull(),
  hotlineNumber: text('hotline_number').default('0225006000').notNull(),
  inquiriesNumber: text('inquiries_number').default('01100000000').notNull(),
  vodafoneCashNumber: text('vodafone_cash_number').default('01000000000'),
