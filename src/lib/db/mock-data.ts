...
export const INITIAL_LESSONS: MockLesson[] = [
  ...
  // Grade 1 Unit 2 (u-102)
  {
    id: 'les-102-1',
    unitId: 'u-102',
    title: 'الدرس 1 و 2: أفراد العائلة (Family Members & My Home)',
    slug: 'family-members-and-home',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '25 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'ملزمة أفراد الأسرة وكلمات المنزل الملونة.pdf',
    isFreePreview: true,
    orderIndex: 1,
  },
  {
    id: 'les-102-2',
    unitId: 'u-102',
    title: 'الدرس 3: الألعاب المفضلة وأسماء الإشارة (Toys & This is my...)',
    slug: 'toys-and-demonstratives',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '22 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'تدريبات الألعاب والتلوين.pdf',
    isFreePreview: false,
    orderIndex: 2,
  },
  {
    id: 'les-102-3',
    unitId: 'u-102',
    title: 'الدرس 4: صوتيات حرفي P و T والعد حتى 10 (Phonics P, T & Counting)',
    slug: 'phonics-p-t-counting',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '26 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'كراسة الصوتيات والأرقام.pdf',
    isFreePreview: false,
    orderIndex: 3,
  },
  {
    id: 'les-102-4',
    unitId: 'u-102',
    title: 'مراجعة شاملة وحل تدريبات كتاب الوزارة والامتحان التراكمي',
    slug: 'grade-1-unit-2-revision',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '30 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'امتحان الوحدة الثانية التراكمي.pdf',
    isFreePreview: false,
    orderIndex: 4,
  },
  // Grade 2 Unit 1 (u-201)
  {
    id: 'les-201-1',
    unitId: 'u-201',
    title: 'الدرس 1: تقديم العائلة والتحيات الصباحية (Meet My Family & Daily Greetings)',
    slug: 'meet-my-family-lesson-1',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '24 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'شجرة العائلة والتحيات اليومية.pdf',
    isFreePreview: true,
    orderIndex: 1,
  },
  {
    id: 'les-201-2',
    unitId: 'u-201',
    title: 'الدرس 2: استخدام This is للمفرد و These are للجمع مع أفراد الأسرة',
    slug: 'this-is-these-are-grammar',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '26 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'قواعد المفرد والجمع وتدريبات كتابة الجمل.pdf',
    isFreePreview: false,
    orderIndex: 2,
  },
  {
    id: 'les-201-3',
    unitId: 'u-201',
    title: 'الدرس 3: صوتيات مقطع Ch في كلمات Children و Teacher و Beach',
    slug: 'phonics-ch-sound-grade-2',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '20 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'تدريبات صوتيات Ch مع النطق التفاعلي.pdf',
    isFreePreview: false,
    orderIndex: 3,
  },
  {
    id: 'les-201-4',
    unitId: 'u-201',
    title: 'الدرس 4: مراجعة شاملة وتدريبات حل القطعة وأسئلة امتحانات الشهر',
    slug: 'grade-2-unit-1-exam-prep',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '32 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'بنك أسئلة الوحدة الأولى للصف الثاني الابتدائي.pdf',
    isFreePreview: false,
    orderIndex: 4,
  },
  // Grade 3 Unit 1 (u-301)
  {
    id: 'les-301-1',
    unitId: 'u-301',
    title: 'الدرس 1: التعبير عن المشاعر (Feelings & Emotions: How do you feel?)',
    slug: 'feelings-how-do-you-feel',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '27 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'ملزمة المشاعر وتكوين جمل الإحساس.pdf',
    isFreePreview: true,
    orderIndex: 1,
  },
  {
    id: 'les-301-2',
    unitId: 'u-301',
    title: 'الدرس 2: العادات الصحية السليمة والطعام الصحي (Healthy Living Habits)',
    slug: 'healthy-living-habits',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '25 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'العادات الصحية وتغذية أبطال الابتدائي.pdf',
    isFreePreview: false,
    orderIndex: 2,
  },
  {
    id: 'les-301-3',
    unitId: 'u-301',
    title: 'الدرس 3: صوتيات المد الطويل Long /e/ (ee & ea: Bee, Leaf, Clean)',
    slug: 'phonics-long-e-ee-ea',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '23 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'صوتيات الياء الممدودة مع أغنية النحلة والورقة.pdf',
    isFreePreview: false,
    orderIndex: 3,
  },
  {
    id: 'les-301-4',
    unitId: 'u-301',
    title: 'الدرس 4: حل تدريبات الاستماع وتكوين الجمل والامتحان التراكمي',
    slug: 'grade-3-unit-1-exam-review',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '34 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'نموذج امتحان شهر أكتوبر للصف الثالث.pdf',
    isFreePreview: false,
    orderIndex: 4,
  },
  // Grade 4 Unit 1 (u-401)
  {
    id: 'les-401-1',
    unitId: 'u-401',
    title: 'Lesson 1: Food & The Digestive System (الجهاز الهضمي وعملية الهضم)',
    slug: 'digestive-system-connect-plus',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '28 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'ملزمة الجهاز الهضمي ومصطلحات العلوم بالإنجليزية.pdf',
    isFreePreview: true,
    orderIndex: 1,
  },
  {
    id: 'les-401-2',
    unitId: 'u-401',
    title: 'Lesson 2: The Respiratory System (الجهاز التنفسي وصحة الرئتين)',
    slug: 'respiratory-system-lungs',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '26 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'شرح الجهاز التنفسي والقلب بالرسوم التوضيحية.pdf',
    isFreePreview: false,
    orderIndex: 2,
  },
  {
    id: 'les-401-3',
    unitId: 'u-401',
    title: 'Lesson 3: Phonics & The Prefix re- (بادئة إعادة الفعل re- مع التدريبات)',
    slug: 'prefix-re-grammar-phonics',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '22 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'قواعد البادئات والصوتيات لمنهج كونكت بلس.pdf',
    isFreePreview: false,
    orderIndex: 3,
  },
  {
    id: 'les-401-4',
    unitId: 'u-401',
    title: 'Lesson 4: Unit Exam & Advanced Reading Comprehension Questions',
    slug: 'grade-4-unit-1-exam-comprehension',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '36 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'نماذج امتحانات الوزارة الرسمية للصف الرابع.pdf',
    isFreePreview: false,
    orderIndex: 4,
  },
  // Grade 5 Unit 1 (u-501)
  {
    id: 'les-501-1',
    unitId: 'u-501',
    title: 'Lesson 1: Food We Grow (الفاكهة والخضروات وزراعة البقوليات والفاكهة)',
    slug: 'food-we-grow-egypt',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '29 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'ملزمة الزراعة والبيئة المصرية والمفردات.pdf',
    isFreePreview: true,
    orderIndex: 1,
  },
  {
    id: 'les-501-2',
    unitId: 'u-501',
    title: 'Lesson 2: Story Time: Jack and the Beanstalk (قصة جاك وشجرة الفاصوليا)',
    slug: 'jack-and-the-beanstalk-story',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '31 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'القصة المقررة مع تحليل الكلمات والقواعد.pdf',
    isFreePreview: false,
    orderIndex: 2,
  },
  {
    id: 'les-501-3',
    unitId: 'u-501',
    title: 'Lesson 3: Countable and Uncountable Nouns (الأسماء المعدودة وغير المعدودة)',
    slug: 'countable-uncountable-nouns',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '27 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'شرح Some و Any وأدوات الكميات.pdf',
    isFreePreview: false,
    orderIndex: 3,
  },
  {
    id: 'les-501-4',
    unitId: 'u-501',
    title: 'Lesson 4: Comprehensive Ministry Unit Test & Model Answer Revision',
    slug: 'grade-5-unit-1-ministry-test',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '38 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'امتحان شامل مطابق لأحدث مواصفات الوزارة.pdf',
    isFreePreview: false,
    orderIndex: 4,
  },
  // Grade 6 Unit 1 (u-601)
  {
    id: 'les-601-1',
    unitId: 'u-601',
    title: 'Lesson 1: Community Gardens & Green Spaces (حدائق الأسطح والمجتمعات الخضراء)',
    slug: 'community-gardens-green-spaces',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '30 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'ملزمة البيئة الخضراء وحدائق المدن.pdf',
    isFreePreview: true,
    orderIndex: 1,
  },
  {
    id: 'les-601-2',
    unitId: 'u-601',
    title: 'Lesson 2: Present Simple & Adverbs of Frequency (المضارع البسيط وظروف التكرار)',
    slug: 'present-simple-adverbs-frequency',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '28 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'قواعد التكرار Always, Usually, Often, Never.pdf',
    isFreePreview: false,
    orderIndex: 2,
  },
  {
    id: 'les-601-3',
    unitId: 'u-601',
    title: 'Lesson 3: Phonics & Pronunciation: Silent Letters in English Words',
    slug: 'silent-letters-phonics-grade-6',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '24 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'الحروف الصامتة وأهم استثناءات النطق.pdf',
    isFreePreview: false,
    orderIndex: 3,
  },
  {
    id: 'les-601-4',
    unitId: 'u-601',
    title: 'Lesson 4: Primary 6 Certificate Final Revision & Model Exams',
    slug: 'grade-6-unit-1-certificate-exam',
    videoUrl: 'https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8',
    videoDuration: '40 دقيقة',
    pdfAttachmentUrl: '/sample-notes.pdf',
    pdfTitle: 'نماذج امتحانات الشهادة الابتدائية الشاملة.pdf',
    isFreePreview: false,
    orderIndex: 4,
  },
];
  ...
  questions: [
    {
      ...
      remedialLessonSlug: 'greetings-and-conversation',
      remedialTimestampSeconds: 45,
    },
    {
      id: 'q2',
...
export const INITIAL_PLATFORM_SETTINGS: MockPlatformSettings = {
  ...
  sampleLectures: [
    {
      id: 'samp-1',
      title: 'Oxford Phonics World — مغامرة الحروف والصوتيات',
      description: 'شرح كرتوني تفاعلي للمبتدئين — Alphabet & Letter Sounds',
      videoUrl: 'https://www.youtube.com/watch?v=G3zaC5onBvM',
      thumbnailUrl: 'https://img.youtube.com/vi/G3zaC5onBvM/hqdefault.jpg',
      badgeText: 'كرتون تفاعلي 🎨',
      orderIndex: 1,
    },
    {
      id: 'samp-2',
      title: 'English Singsing — أناشيد نطق الكلمات والمفردات',
      description: 'Phonics Word Songs A to Z — رسوم متحركة ونطق سليم للأطفال',
      videoUrl: 'https://www.youtube.com/watch?v=VsdnkXjybAQ',
      thumbnailUrl: 'https://img.youtube.com/vi/VsdnkXjybAQ/hqdefault.jpg',
      badgeText: 'أغاني كرتونية 🎵',
      orderIndex: 2,
    },
    {
      id: 'samp-3',
      title: 'Short Vowels & Phonics — نطق الحركات والكلمات',
      description: 'تأسيس القراءة بالإنجليزية بأسلوب مبسط — Word Families & Sounds',
      videoUrl: 'https://www.youtube.com/watch?v=BsAd9pPUxBg',
      thumbnailUrl: 'https://img.youtube.com/vi/BsAd9pPUxBg/hqdefault.jpg',
      badgeText: 'تأسيس القراءة 📖',
      orderIndex: 3,
    },
    {
      id: 'samp-4',
      title: 'قصص كرتونية لتعليم الإنجليزية ومحادثات الأطفال',
      description: 'English Phonics Stories — قصص مصورة ممتعة وحوارات يومية',
      videoUrl: 'https://www.youtube.com/watch?v=9C1qj06xduo',
      thumbnailUrl: 'https://img.youtube.com/vi/9C1qj06xduo/hqdefault.jpg',
      badgeText: 'قصص وحوارات ✨',
      orderIndex: 4,
    },
  ],
};
