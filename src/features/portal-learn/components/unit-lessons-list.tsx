      ...
      {lessons.length === 0 ? (
        ...
        <div className="space-y-3.5">
          {lessons.map((lesson, idx) => (
            <Card
              key={lesson.id}
              className="bg-white/95 backdrop-blur-md p-5 border-2 border-purple-100 hover:border-purple-300 transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-sm hover:shadow-md"
            >
