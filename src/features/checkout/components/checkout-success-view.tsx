...
export function CheckoutSuccessView({ message, onClose }: CheckoutSuccessViewProps) {
  return (
    <div className="text-center py-8 space-y-4 animate-in zoom-in-95" role="status" aria-live="polite">
      ...
      <h2 className="text-xl font-black text-slate-900">تم تفعيل الاشتراك بنجاح!</h2>
