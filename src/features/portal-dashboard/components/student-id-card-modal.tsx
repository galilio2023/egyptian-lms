...
export function StudentIDCardModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-md animate-in fade-in-50 overflow-y-auto print:p-0 print:bg-white print:fixed print:inset-0">
      <div className="w-full max-w-md rounded-3xl p-5 sm:p-7 space-y-4 border-2 border-purple-300 shadow-2xl bg-white relative my-auto print:border-0 print:shadow-none">
        ...
        <button
          onClick={onClose}
          className="print:hidden absolute top-4 end-4 p-2 rounded-2xl bg-purple-50 hover:bg-purple-100 text-purple-700 transition-colors cursor-pointer"
          aria-label="إغلاق"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="text-center space-y-1">
          ...
          <h2 className="text-xl font-black text-slate-900">{academyName}</h2>
        ...
        <div className="print:hidden pt-2 flex items-center gap-2">
          <button
            ...
            className="flex-1 py-3 rounded-2xl bg-purple-600 hover:bg-purple-700 text-white font-black text-xs flex items-center justify-center gap-2 shadow-md shadow-purple-600/20 transition-all cursor-pointer"
          >
