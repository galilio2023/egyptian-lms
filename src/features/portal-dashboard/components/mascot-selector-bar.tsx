...
export const MascotSelectorBar: React.FC<MascotSelectorBarProps> = ({
  ...
  return (
    <div className="modern-card p-4 sm:p-6 bg-white/95 backdrop-blur-md border-2 border-purple-100 rounded-3xl shadow-md space-y-4">
        ...
        {mascots.map((m) => {
          ...
          return (
            <button
              ...
              className={`p-2.5 sm:p-3.5 rounded-2xl border-2 text-right transition-all flex items-center gap-2.5 sm:gap-3 cursor-pointer ${
                isSelected
            ...
            >
              <IconSvg className="w-8 h-8 sm:w-9 sm:h-9 shrink-0 drop-shadow-xs" />
